...
function displayAnime(filteredAnimeList = animeList) {
...
document.getElementById("searchBar").addEventListener("input", function() {
    ...
    const filteredAnimeList = animeList.filter(anime => anime.name.toLowerCase().includes(searchText));
    displayAnime(filteredAnimeList);
});
