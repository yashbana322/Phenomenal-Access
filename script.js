...
// 🔥 Function to Display Anime (Now Works Correctly)
function displayAnime() {
    const container = document.getElementById("animeContainer");

    // ❌ Stop reloading content (Fixing the blinking issue)
...
// 🔥 Run Display Function When Page Loads (Fixing Blinking Issue)
