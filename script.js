...
function displayAnime() {
    ...
    if (!container) {
        console.error("❌ ERROR: 'animeContainer' not found in HTML!");
        return;
    }
    ...
    animeList.forEach(anime => {
        ...
        img.onerror = function() { 
            console.warn(`⚠️ Image not found: ${anime.img}, using default.`);
            img.src = "images/default.jpg"; // If image fails, load default image
        };
