...
function displayAnime() {
    ...
    container.innerHTML = ""; // Clear container before adding anime
    ...
    animeList.forEach(anime => {
        ...
        img.src = anime.img;
        img.alt = anime.name;
        img.onerror = function() { img.src = "images/default.jpg"; }; // Load default image if error
